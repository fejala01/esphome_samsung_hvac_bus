        ...
        */
        ...
        void NasaProtocol::publish_request(MessageTarget *target, const std::string &address, ProtocolRequest &request)
        {
            ...
            if (request.fsv_read3)
            {
                ...
                MessageSet fsv_read2(MessageNumber::VAR_in_fsv3052);
                fsv_read2.value = 0;
                packet.messages.push_back(fsv_read2);
                
                MessageSet fsv_read3(MessageNumber::VAR_in_fsv3071);
                fsv_read3.value = 0;
                packet.messages.push_back(fsv_read3);
                
                MessageSet fsv_read4(MessageNumber::VAR_in_fsv3081);
                fsv_read4.value = 0;
                packet.messages.push_back(fsv_read4);

                MessageSet fsv_read5(MessageNumber::VAR_in_fsv3082);
                fsv_read5.value = 0;
                packet.messages.push_back(fsv_read5);

                MessageSet fsv_read6(MessageNumber::VAR_in_fsv3083);
                fsv_read6.value = 0;
                packet.messages.push_back(fsv_read6);                
            }
            ...
            if (request.fsv_read5)
            {
                ...
                MessageSet fsv_read1(MessageNumber::VAR_in_fsv4041);
                fsv_read1.value = 0;
                packet.messages.push_back(fsv_read1);

                MessageSet fsv_read2(MessageNumber::VAR_in_fsv4042);
                fsv_read2.value = 0;
                packet.messages.push_back(fsv_read2);
                
                MessageSet fsv_read3(MessageNumber::VAR_in_fsv4043);
                fsv_read3.value = 0;
                packet.messages.push_back(fsv_read3);
                
                MessageSet fsv_read4(MessageNumber::VAR_in_fsv4044);
                fsv_read4.value = 0;
                packet.messages.push_back(fsv_read4);

                MessageSet fsv_read5(MessageNumber::VAR_in_fsv4045);
                fsv_read5.value = 0;
                packet.messages.push_back(fsv_read5);

                MessageSet fsv_read6(MessageNumber::VAR_in_fsv4046);
                fsv_read6.value = 0;
                packet.messages.push_back(fsv_read6);
            ...
            if (request.fsv_read7)
            {
                ...
                MessageSet fsv_read6(MessageNumber::ENUM_in_fsv5051);
                fsv_read6.value = 0;
                packet.messages.push_back(fsv_read6);

                MessageSet fsv_read7(MessageNumber::ENUM_in_fsv5081);
                fsv_read7.value = 0;
                packet.messages.push_back(fsv_read7);
            ...
            if (request.fsv_read8)
            {
                ...
                MessageSet fsv_read2(MessageNumber::ENUM_in_fsv5091);
                fsv_read2.value = 0;
                packet.messages.push_back(fsv_read2);

                MessageSet fsv_read3(MessageNumber::VAR_in_fsv5092);
                fsv_read3.value = 0;
                packet.messages.push_back(fsv_read3);

                MessageSet fsv_read4(MessageNumber::VAR_in_fsv5093);
                fsv_read4.value = 0;
                packet.messages.push_back(fsv_read4);

                MessageSet fsv_read5(MessageNumber::ENUM_in_fsv5094);
                fsv_read5.value = 0;
                packet.messages.push_back(fsv_read5);
            ...
            if (request.fsv1061)
            {
                ...
                if (fsv1061.value < 0) {
                    fsv1061.value = 65536 + fsv1061.value;
                }
            ...
            if (request.fsv1062)
            {
                ...
                if (fsv1062.value < 0) {
                    fsv1062.value = 65536 + fsv1062.value;
                }
            ...
            if (request.fsv3052) 
            {
                ...
                MessageSet fsv3052(MessageNumber::VAR_in_fsv3052); 
                fsv3052.value = request.fsv3052.value(); 
                packet.messages.push_back(fsv3052); 
            }
        ...
        void process_messageset(std::string source, std::string dest, MessageSet &message, MessageTarget *target)
        {
            ...
            case MessageNumber::VAR_in_water_pressure: // unit = 'Celsius' from XML
            {
                ...
                LOG_MESSAGE(VAR_in_water_pressure, temp, source, dest);
            ...
            case MessageNumber::VAR_out_coolant: 
            {
                ...
                target->set_coolant(source, temp);
                break;
            }
            ...
            case MessageNumber::VAR_in_fsv5014: // unit = 'Celsius' from XML
                {
                    double temp = (double)message.value / (double)10;
                    LOG_MESSAGE(VAR_in_fsv5014, temp, source, dest);
                    target->set_fsv5014(source, temp);
                    break;
                }
            case MessageNumber::VAR_in_fsv5015: // unit = 'Celsius' from XML
                {
                    double temp = (double)message.value / (double)10;
                    LOG_MESSAGE(VAR_in_fsv5015, temp, source, dest);
                    target->set_fsv5015(source, temp);
                    break;
                }
            case MessageNumber::VAR_in_fsv5016: // unit = 'Celsius' from XML
                {
                    double temp = (double)message.value / (double)10;
                    LOG_MESSAGE(VAR_in_fsv5016, temp, source, dest);
                    target->set_fsv5016(source, temp);
                    break;
                }
            case MessageNumber::VAR_in_fsv5017: // unit = 'Celsius' from XML
                {
                    double temp = (double)message.value / (double)10;
                    LOG_MESSAGE(VAR_in_fsv5017, temp, source, dest);
                    target->set_fsv5017(source, temp);
                    break;
                }
            case MessageNumber::VAR_in_fsv5018: // unit = 'Celsius' from XML
                {
                    double temp = (double)message.value / (double)10;
                    LOG_MESSAGE(VAR_in_fsv5018, temp, source, dest);
                    target->set_fsv5018(source, temp);
                    break;
                }
            case MessageNumber::VAR_in_fsv5019: // unit = 'Celsius' from XML
                {
                    double temp = (double)message.value / (double)10;
                    LOG_MESSAGE(VAR_in_fsv5019, temp, source, dest);
                    target->set_fsv5019(source, temp);
                    break;
                }
            ...
            {
                double temp = (double)message.value / (double)10;
                LOG_MESSAGE(VAR_in_fsv3021, temp, source, dest);
                target->set_fsv3021(source, temp);
                break;
            }

            case MessageNumber::VAR_in_fsv3022: // unit = 'Celsius'
            {
                double temp = (double)message.value / (double)10;
            ...
            case MessageNumber::VAR_in_fsv3023: // unit = 'Celsius'
            {
                double temp = (double)message.value / (double)10;
            ...
            case MessageNumber::VAR_in_fsv3024:
            {
                double temp = (double)message.value;
                LOG_MESSAGE(VAR_in_fsv3024, temp, source, dest);
                target->set_fsv3024(source, temp);
                break;
            }

            case MessageNumber::VAR_in_fsv3025:
            {
                double temp = (double)message.value;
                LOG_MESSAGE(VAR_in_fsv3025, temp, source, dest);
                target->set_fsv3025(source, temp);
                break;
            }

            case MessageNumber::VAR_in_fsv3026:
            {
                double temp = (double)message.value;
                LOG_MESSAGE(VAR_in_fsv3026, temp, source, dest);
                target->set_fsv3026(source, temp);
                break;
            }
            ...
            case MessageNumber::VAR_in_fsv3033: // unit = 'Celsius'
            {
                double temp = (double)message.value / (double)10;
            ...
            case MessageNumber::VAR_in_fsv3044: // unit = 'Celsius'
            {
                double temp = (double)message.value / (double)10;
            ...
            case MessageNumber::VAR_in_fsv3052:
            {
                double temp = (double)message.value;
                LOG_MESSAGE(VAR_in_fsv3052, temp, source, dest);
                target->set_fsv3052(source, temp);
                break;
            }
            ...
            case MessageNumber::VAR_in_fsv3081:
            {
                double temp = (double)message.value;
                LOG_MESSAGE(VAR_in_fsv3081, temp, source, dest);
                target->set_fsv3081(source, temp);
                break;
            }

            case MessageNumber::VAR_in_fsv3082:
            {
                double temp = (double)message.value;
                LOG_MESSAGE(VAR_in_fsv3082, temp, source, dest);
                target->set_fsv3082(source, temp);
                break;
            }

            case MessageNumber::VAR_in_fsv3083:
            {
                double temp = (double)message.value;
                LOG_MESSAGE(VAR_in_fsv3083, temp, source, dest);
                target->set_fsv3083(source, temp);
                break;
            }
            ...
            {
                double temp = (double)message.value / (double)10;
                LOG_MESSAGE(VAR_in_fsv4013, temp, source, dest); 
                target->set_fsv4013(source, temp); 
                break;
            }

            case MessageNumber::VAR_in_fsv4021:
            {
                double temp = (double)message.value;
                LOG_MESSAGE(VAR_in_fsv4021, temp, source, dest); 
                target->set_fsv4021(source, temp); 
                break;
            }

            case MessageNumber::VAR_in_fsv4022:
            {
                double temp = (double)message.value;
            ...
            {
                double temp = (double)message.value / (double)10;
                LOG_MESSAGE(VAR_in_fsv4025, temp, source, dest); 
                target->set_fsv4025(source, temp); 
                break;
            }

            case MessageNumber::VAR_in_fsv4031:
            {
                double temp = (double)message.value;
                LOG_MESSAGE(VAR_in_fsv4031, temp, source, dest); 
                target->set_fsv4031(source, temp); 
                break;
            }

            case MessageNumber::VAR_in_fsv4032:
            {
                double temp = (double)message.value;
            ...
            case MessageNumber::VAR_in_fsv5082: // unit = 'Celsius' from XML
            {
                double temp = (double)message.value / (double)10;
                LOG_MESSAGE(VAR_in_fsv5082, temp, source, dest);
                target->set_fsv5082(source, temp);
                break;
            }

            case MessageNumber::VAR_in_fsv5083: // unit = 'Celsius' from XML
            {
                double temp = (double)message.value / (double)10;
                LOG_MESSAGE(VAR_in_fsv5083, temp, source, dest);
                target->set_fsv5083(source, temp);
                break;
            }

            case MessageNumber::VAR_in_fsv5092: // unit = 'Celsius' from XML
            {
                double temp = (double)message.value / (double)10;
                LOG_MESSAGE(VAR_in_fsv5092, temp, source, dest);
                target->set_fsv5092(source, temp);
                break;
            }

            case MessageNumber::VAR_in_fsv5093: // unit = 'Celsius' from XML
            {
                double temp = (double)message.value / (double)10;
                LOG_MESSAGE(VAR_in_fsv5093, temp, source, dest);
                target->set_fsv5093(source, temp);
                break;
            }
            ...
            case MessageNumber::ENUM_in_main_switch:
            {
                LOG_MESSAGE(ENUM_in_main_switch, (double)message.value, source, dest);
                target->set_main_switch(source, message.value != 0);
                break;
            }
            ...
            {
                LOG_MESSAGE(ENUM_in_operation, (double)message.value, source, dest);
                target->set_operation(source, message.value != 0);
                break;
            }
            ...
            case MessageNumber::ENUM_in_fsv5051:
            {
                LOG_MESSAGE(ENUM_in_fsv5051, (double)message.value, source, dest);
                target->set_fsv5051(source, message.value != 0);
                break;
            }
            case MessageNumber::ENUM_in_fsv5081:
            {
                LOG_MESSAGE(ENUM_in_fsv5081, (double)message.value, source, dest);
                target->set_fsv5081(source, message.value != 0);
                break;
            }
            case MessageNumber::ENUM_in_fsv5091:
            {
                LOG_MESSAGE(ENUM_in_fsv5091, (double)message.value, source, dest);
                target->set_fsv5091(source, message.value != 0);
                break;
            }
            case MessageNumber::ENUM_in_fsv5094:
            {
                LOG_MESSAGE(ENUM_in_fsv5094, (double)message.value, source, dest);
                target->set_fsv5094(source, message.value != 0);
                break;
            }
        ...
        void process_nasa_packet(MessageTarget *target)
        {
            ...
            while (it != sent_packets.end()) {
                if (now - it->last_sent_time > 1750 && it->retry_count < 3) {
                    it->retry_count++;
