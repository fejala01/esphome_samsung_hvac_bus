...
namespace esphome
{
    namespace samsung_ac
    {
        ...
        enum class MessageNumber : uint16_t
        {
            ...
            VAR_in_fsv1061 = 0x431E,
            VAR_in_fsv1062 = 0x431F,
            ...
            ENUM_in_fsv4023 = 0x40A1,
            VAR_in_fsv4024 = 0x4270,
            VAR_in_fsv4025 = 0x4271,
            VAR_in_fsv4031 = 0x40A2,
            VAR_in_fsv4032 = 0x40A3,
            VAR_in_fsv4033 = 0x4272,
            VAR_in_fsv4041 = 0x40C0,
            VAR_in_fsv4042 = 0x4286,
            VAR_in_fsv4043 = 0x4287,
            VAR_in_fsv4044 = 0x40C1,
            VAR_in_fsv4045 = 0x4288,
            VAR_in_fsv4046 = 0x4289,
            VAR_in_fsv4051 = 0x40C2,
            VAR_in_fsv4052 = 0x428A,
            VAR_in_fsv4053 = 0x40C3,
            VAR_in_fsv5021 = 0x427C,
            VAR_in_fsv5023 = 0x42F0,
            ENUM_in_fsv5041 = 0x40A4,
            VAR_in_fsv5042 = 0x40A5,
            ENUM_in_fsv5043 = 0x40A6,
            ENUM_in_fsv5051 = 0x40A7,
            ENUM_in_fsv5081 = 0x411B,
            VAR_in_fsv5082 = 0x42DB,
            VAR_in_fsv5083 = 0x42DC,
            ENUM_in_fsv5091 = 0x411C,
            VAR_in_fsv5092 = 0x42DD,
            VAR_in_fsv5093 = 0x42DE,
            ENUM_in_fsv5094 = 0x411D,
