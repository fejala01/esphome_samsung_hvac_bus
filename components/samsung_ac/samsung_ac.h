...
namespace esphome
{
  namespace samsung_ac
  {
    ...
    public:
      ...
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                 { dev->update_sensor_state(dev->water_law_target, value); });
      }
      void set_sensor_tw1(const std::string address, float value) override
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                 { dev->update_sensor_state(dev->sensor_tw1, value); });
      }
      void set_sensor_tw2(const std::string address, float value) override
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                 { dev->update_sensor_state(dev->sensor_tw2, value); });
      }
      void set_sat_temp_low_pressure(const std::string address, float value) override
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                 { dev->update_sensor_state(dev->sat_temp_low_pressure, value); });
      }
      void set_sat_temp_high_pressure(const std::string address, float value) override
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                 { dev->update_sensor_state(dev->sat_temp_high_pressure, value); });
      }
      ...
      void set_filter_warning(const std::string address, float value) override
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                 { dev->update_sensor_state(dev->filter_warning, value); });
      }
      void set_filter_clean(const std::string address, float value) override
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                 { dev->update_sensor_state(dev->filter_clean, value); });
      }
      ...
      void set_fsv1061(const std::string address, float value) override
      {
          execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                    { dev->update_fsv1061(value); });
      }
      void set_fsv1062(const std::string address, float value) override
      {
          execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                    { dev->update_fsv1062(value); });
      }
      ...
      void set_fsv4024(const std::string address, float value) override
      {
          execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
          { dev->update_fsv4024(value); });
      }
      ...
      void set_fsv4033(const std::string address, float value) override
      {
          execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                    { dev->update_fsv4033(value); });
      }

      void set_fsv4041(const std::string address, float value) override
      {
          execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
          { dev->update_fsv4041(value); });
      }

      void set_fsv4042(const std::string address, float value) override
      {
          execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
          { dev->update_fsv4042(value); });
      }

      void set_fsv4043(const std::string address, float value) override
      {
          execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
          { dev->update_fsv4043(value); });
      }

      void set_fsv4044(const std::string address, float value) override
      {
          execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
          { dev->update_fsv4044(value); });
      }

      void set_fsv4045(const std::string address, float value) override
      {
          execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
          { dev->update_fsv4045(value); });
      }

      void set_fsv4046(const std::string address, float value) override
      {
          execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
          { dev->update_fsv4046(value); });
      }

      void set_fsv4051(const std::string address, float value) override
      {
          execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
          { dev->update_fsv4051(value); });
      }
      ...
      void set_fsv4053(const std::string address, float value) override
      {
          execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
          { dev->update_fsv4053(value); });
      }

      void set_fsv5021(const std::string address, float value) override
      {
          execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
      ...
      void set_main_switch(const std::string address, bool value) override
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                 { dev->update_main_switch(value); });
      }
      ...
      void set_fsv3031(const std::string address, bool value) override
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                 { dev->update_fsv3031(value); });
      }
      void set_fsv3041(const std::string address, bool value) override
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                 { dev->update_fsv3041(value); });
      }
      void set_fsv3051(const std::string address, bool value) override
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                 { dev->update_fsv3051(value); });
      }
      void set_fsv4023(const std::string address, bool value) override
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                 { dev->update_fsv4023(value); });
      }
      void set_fsv4061(const std::string address, bool value) override
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
                                 { dev->update_fsv4061(value); });
      }
      void set_fsv5022(const std::string address, bool value) override
      {
        execute_if_device_exists(address, [value](Samsung_AC_Device *dev)
